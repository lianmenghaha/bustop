...
public class Test_KO {
    ...
    public static void main (String[] args){
        ...
        Poly_Keepout poly_KO = new Poly_Keepout("poly_KO",-451, 461, 1455, 2352);
        poly_keepouts.add(poly_KO);


        Keepout v_ko1 = new Keepout("v_ko1", -451,-20,1455,1992);
        Keepout v_ko2 = new Keepout("v_ko2", -39,461,1455,2352);
        ArrayList<Keepout> keepouts = new ArrayList<>();
        keepouts.add(v_ko1);
        keepouts.add(v_ko2);
        poly_KO.setInner_Keepouts_V(keepouts);

        Keepout h_ko1 = new Keepout("h_ko1", -451, 461, 1455, 1992);
        Keepout h_ko2 = new Keepout("h_ko2", -39, 461, 1992, 2352);
